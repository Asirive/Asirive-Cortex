...
**If It Fails:**
- Check: `.env` file has `GEMINI_API_KEY=<REDACTED-GEMINI-KEY>`
...
Run in PowerShell:
```powershell
$env:GEMINI_API_KEY="<REDACTED-GEMINI-KEY>"
python -c "import google.generativeai as genai; genai.configure(api_key='<REDACTED-GEMINI-KEY>'); print('API Key Valid')"
```
