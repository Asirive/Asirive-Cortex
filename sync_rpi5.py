...
- RPi5 IP: 10.41.240.31
- Laptop IP: 10.41.240.101
    ...
    for config_path in config_paths:
        if config_path.exists():
            try:
                ...
                return {
                    'host': rpi_config.get('host', '10.41.240.31'),
                    'user': rpi_config.get('user', 'cortex'),
                    'path': rpi_config.get('path', '/home/cortex/ProjectCortex'),
                    'laptop_host': laptop_config.get('host', '10.41.240.101'),
                }
...
def get_rpi_password():
    ...
    return os.environ.get("RPI_PASSWORD", "REDACTED-RPI-PASSWORD")
