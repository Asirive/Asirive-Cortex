...
sed_cmd = 'echo Haziqshah21 | sudo -S sed -i "s/^#AlwaysPairable = false/AlwaysPairable = true/" /etc/bluetooth/main.conf'
...
# Restart bluetooth
stdin, stdout, stderr = c.exec_command('echo Haziqshah21 | sudo -S systemctl restart bluetooth')
time.sleep(3)
